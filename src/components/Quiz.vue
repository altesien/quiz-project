<template>
    ...
    <div v-else class="grid grid-rows-6 grid-cols-1 text-gray-600 mx-auto w-11/12 md:w-8/12 lg:w-7/12 overflow-y-hidden custom-height">
        <div class="row-span-2">
            <div class="min-h-full justify-between py-4 rounded-lg flex flex-col items-center">
                <div class="flex my-4">
                    <div
                        v-for="(item, index) in store.data.results" :key="index"
            ...
            <div class="row-span-3">
                <div class="min-h-full flex flex-col justify-center">
                    ...
                    <Answer
                        ...
                        :text="answer"
                        :is-valid-answer="
                        answer == store.data[store.currentQuestion].Answer
                        "
                        :is-invalid-answer="
                        answer != store.data[store.currentQuestion].Answer
                        "
